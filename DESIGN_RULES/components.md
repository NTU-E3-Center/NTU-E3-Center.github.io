...
Publications + Projects; People = Members (`/members/`) + Students & Alumni
(`/students/`) — two plain destinations, no subnav; News & Life = News + Group Life); entries without the field stay plain
